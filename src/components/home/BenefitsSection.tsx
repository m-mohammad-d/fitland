...
export default function BenefitsSection() {
  return (
    <div className="bg-secondary-0">
      <div className="max-w-[1100px] h-full md:h-60 w-full mx-auto justify-between py-8 flex flex-col md:flex-row items-center">
        ...
        <h2 className="text-lg font-semibold text-gray-800 my-6 text-center">
