...
const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const baseStyles =
      "relative w-full mt-2 bg-transparent border border-neutral-gray-3 rounded-md focus:border-primary transition duration-300 outline-none focus:outline-none";
      ...
      >
        <div className="relative">
          ...
          <input
            ...
            className={cn(
              baseStyles,
              errorMessage && stateStyles.error,
          ...
          {type === "password" && (
            <button
              ...
              className="absolute left-2 top-[3.3rem] -translate-y-1/2 transform text-gray-500"
            >
